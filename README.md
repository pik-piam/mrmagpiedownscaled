...
R package **mrdownscale**, version **0.11.6**
...
Sauer P, Dietrich J (2023). _mrdownscale: Downscale and harmonize MAgPIE output using LUH2 as reference data_. R package version 0.11.6, <URL: https://github.com/pik-piam/mrdownscale>.
