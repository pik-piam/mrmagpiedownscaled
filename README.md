...
R package **mrdownscale**, version **0.27.0**
...
Sauer P, Dietrich J (2024). _mrdownscale: Downscale and harmonize land use data using high resolution reference data_. doi:10.5281/zenodo.11244475 <https://doi.org/10.5281/zenodo.11244475>, R package version 0.27.0, <https://github.com/pik-piam/mrdownscale>.
