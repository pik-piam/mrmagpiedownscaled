...
R package **mrdownscale**, version **0.24.1**
...
Sauer P, Dietrich J (2024). _mrdownscale: Downscale and harmonize MAgPIE output using LUH2 as reference data_. doi:10.5281/zenodo.11244475 <https://doi.org/10.5281/zenodo.11244475>, R package version 0.24.1, <https://github.com/pik-piam/mrdownscale>.
