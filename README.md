...
R package **mrdownscale**, version **0.4.0**
...
Führlich P (2023). _mrdownscale: Downscale and harmonize MAgPIE output using LUH2 as reference data_. R package version 0.4.0, <URL: https://github.com/pik-piam/mrdownscale>.
