...
R package **mrdownscale**, version **0.17.0**
...
Sauer P, Dietrich J (2024). _mrdownscale: Downscale and harmonize MAgPIE output using LUH2 as reference data_. R package version 0.17.0, <https://github.com/pik-piam/mrdownscale>.
